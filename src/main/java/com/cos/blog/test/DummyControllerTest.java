...
public class DummyControllerTest {
	...
	public User detail(@PathVariable int id) {
		// user/4를 찾았을 때 데이터베이스에서 못 찾아오게 되면 user가 null이 됨
		// 그럼 return이 null이 됨... 그럼 프로그램에 문제가 됨...
		// Optional로 User 객체를 감싸 가져와서 null인지 아닌지 판단해서 return 
		...
		// 요청 : 웹브라우저
		// user 객체 = 자바 오브젝트
		// html은 user 객체를 이해하지 못 하니까 변환을 해줘야함. (웹 프라우저가 이해할 수 있는 데이터 : json)
